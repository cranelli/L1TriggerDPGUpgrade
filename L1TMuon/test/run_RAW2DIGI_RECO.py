#
# Taking Particle Gun Configuration File,
# and Adapting it to run over an already produced RAW
# sample.
#
...
infile = ['file:' +runParameters.PREFIX+'_GEN_SIM_RAW.root']
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string(runParameters.PREFIX + '_RAW2DIGI_RECO.root'),
