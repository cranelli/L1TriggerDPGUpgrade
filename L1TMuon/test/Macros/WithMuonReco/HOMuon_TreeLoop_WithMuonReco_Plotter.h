...
// Fri May  9 12:39:11 2014 by ROOT version 5.34/10
// from TTree ho_muon_tree/Generator, Propagator, and Reco Data
// found on file: ../../RootFiles/SingleMu14Pt_PostLS1_caloInspector.root
//////////////////////////////////////////////////////////
...
public :
   ...
   vector<float>   *RecoMuons_Etas;
   vector<float>   *RecoMuons_Phis;
   vector<float>   *RecoMuons_Pts;
   ...
   TBranch        *b_RecoMuons_Etas;   //!
   TBranch        *b_RecoMuons_Phis;   //!
   TBranch        *b_RecoMuons_Pts;   //!
   ...
   std::map<std::string,TH1F*> _h1DeltaPt;
   std::map<std::string,TH1F*> _h1DeltaInvPt;

   void FillDeltaPtHistograms(float pt1, float pt2, std::string key);
...
void HOMuon_TreeLoop_WithMuonReco_Plotter::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("RecoMuons_Etas", &RecoMuons_Etas, &b_RecoMuons_Etas);
   fChain->SetBranchAddress("RecoMuons_Phis", &RecoMuons_Phis, &b_RecoMuons_Phis);
   fChain->SetBranchAddress("RecoMuons_Pts", &RecoMuons_Pts, &b_RecoMuons_Pts);
}
